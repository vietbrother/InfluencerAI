    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            {{--<li><a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i>--}}
                ...
                {{--</ul>--}}
            {{--</li>--}}
            {{--<li><a href="javascript:void(0);" class="waves-effect"><i class="linea-icon linea-basic fa-fw text-danger"--}}
                                                                      {{--data-icon="7"></i> <span--}}
            ...
            {{--<li><a href="inbox.html" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i>--}}
                ...
                {{--</ul>--}}
            {{--</li>--}}
            {{--<li><a href="#" class="waves-effect"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i> <span--}}
            ...
            {{--<li><a href="tables.html" class="waves-effect"><i data-icon="O" class="linea-icon linea-software fa-fw"></i>--}}
                    {{--<span class="hide-menu">Tables<span class="fa arrow"></span><span--}}
                ...
                {{--</ul>--}}
            {{--</li>--}}
            {{--<li><a href="widgets.html" class="waves-effect"><i data-icon="P" class="linea-icon linea-basic fa-fw"></i>--}}
                    {{--<span class="hide-menu">Widgets</span></a></li>--}}
